...
public class RutaMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public RutaMainNetParams() {
        super();
    ...
    private static RutaMainNetParams instance;
    public static synchronized RutaMainNetParams get() {
        if (instance == null) {
            instance = new RutaMainNetParams();
        }
        return instance;
    }
