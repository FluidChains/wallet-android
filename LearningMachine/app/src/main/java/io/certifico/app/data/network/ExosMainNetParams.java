...
public class ExosMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public ExosMainNetParams() {
        super();
    ...
    private static ExosMainNetParams instance;
    public static synchronized ExosMainNetParams get() {
        if (instance == null) {
            instance = new ExosMainNetParams();
        }
        return instance;
    }
