...
public class CertificateFragment extends LMFragment {
    ...
    private String displayHTML(BlockCert certificate) {
        ...
        String customCss = "body {padding: 20px; font-size: 12px; line-height: 1.5;} body > section { padding: 0;} body section { max-width: 100%; } body img { max-width: 100%; height: auto; width: inherit; } @media (max-width: 500px) { .bgImage { background-image: none !important; }";
