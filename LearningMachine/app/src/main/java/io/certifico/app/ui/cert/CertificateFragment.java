...
public class CertificateFragment extends LMFragment {
    ...
    private String displayHTML(BlockCert certificate) {
        ...
        String customCss = "body {padding: 20px; font-size: 12px; line-height: 1.5;} body > section { padding: 0;} body section { max-width: 100vw; overflow-wrap: break-word; } body img { max-width: 100%; object-fit: contain; width: 100%; height: 100%; } .bgImage { background-image: none !important; }";
